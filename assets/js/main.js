...
function startCountdown(targetDate, daysId, hoursId, minutesId, secondsId) {
    var countdownFunction = setInterval(function () {
        ...
        document.getElementById(daysId).innerHTML = days + " <span>GÜN</span>";
        document.getElementById(hoursId).innerHTML =
            hours + " <span>SAAT</span>";
        document.getElementById(minutesId).innerHTML =
            minutes + " <span>DAKİKA</span>";
        document.getElementById(secondsId).innerHTML =
            seconds + " <span>SANİYE</span>";
...
// ðŸ“Œ **UTC ile hedef tarihi ayarla**
var targetDate = new Date(Date.UTC(2025, 3, 16, 10, 0, 0)); // 16 Nisan 2025, 10:00:00 UTC
...
circles.forEach((circle) => {
    circle.innerHTML = circle.textContent
